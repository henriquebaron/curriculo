...
\newcommand{\engautomacaoname}{}
\newcommand{\engautomacaodescricao}{}
\newcommand{\projetocomosname}{}
\newcommand{\programacaodeltavname}{}
\newcommand{\coordenacaoobraname}{}
\newcommand{\validacaogmpname}{}
...
\newcommand{\gestaoprojetosname}{Gestão e planejamento de projetos}
...
\newcommand{\programacaoclpauttomname}{Programação de CLPs e IHMs Schneider Electric, Siemens e Allen Bradley}
\newcommand{\programacaosegurancaname}{Programação de controladores de segurança Schneider Electric}
...
\newcommand{\cswinformsname}{C$\sharp$ Windows Forms e WPF}
...
\newcommand{\htmlname}{HTML e CSS Básico}
...
\newcommand{\espanholname}{Espanhol}
\newcommand\francesname{Francês}
\newcommand{\linguamaename}{Língua materna}
\newcommand{\fluentename}{Fluente}
\newcommand{\intermediarioname}{Intermediário}
\newcommand{\basiconame}{Básico}
% Outras habilidades
\newcommand{\outrosname}{Outras competências}
\newcommand{\sistemassccname}{Sistemas SCC}
\newcommand{\outraslinguagensname}{Outras linguagens}
...
\addto\captionsenglish{
	...
	\renewcommand{\gestaoprojetosname}{Project planning and management}
	...
	\renewcommand{\cswinformsname}{C$\sharp$ Windows Forms and WPF}
	\renewcommand{\sqldevname}{SQL for Developers}
	\renewcommand{\htmlname}{HTML and CSS -- Basic}
...
\addto\captionsgerman{
	...
	\renewcommand\localname{Visp}
	% Educação
	\renewcommand{\educacaoname}{Bildung}
	\renewcommand{\brazilname}{~(Brasilien)}
	\renewcommand{\euaname}{~(USA)}
	\renewcommand{\alemanhaname}{~(Deutschland)}
	\renewcommand{\suicaname}{~(Schweiz)}
	...
	% Engenheiro de automação - Lonza
	\renewcommand\engautomacaoname{EMR-Ingenieur}
	\renewcommand\engautomacaodescricao{Planung und Umsetzung von elektro-, mess- und regeltechnische (EMR) Einrichtungen in GMP-Produktionsanlagen}
	\renewcommand\projetocomosname{Anlagenplanung im Bereich Mess- und Elektrotechnik mittels Comos Software}
	\renewcommand\programacaodeltavname{Programmierung und Inbetriebnahme von Emerson DeltaV Prozessleitsysteme (PLS)}
	\renewcommand\coordenacaoobraname{Bauleitung bei den Installationsarbeiten}
	\renewcommand\validacaogmpname{Validierungsverfahren gemäss Vorschriften der GMP - Good Manufacturing Practices}
	% Técnico em P&D - Auttom
	...
	\renewcommand{\gestaoprojetosname}{Projektplanung und -leitung}
	...
	\renewcommand{\programacaoclpfestoname}{Programmierung von Siemens, Festo und Allen Bradley SPS- und HMI-Geräten}
	...
	\renewcommand{\programacaoclpauttomname}{Programmierung von Schneider Electric und Siemens SPS- und HMI-Geräten}
	\renewcommand{\programacaosegurancaname}{Programmierung von Schneider Electric Sicherheitssteuerungen}	
	\renewcommand{\testeemcamponame}{Inbetriebnahme am Kunden}
	% Certificações
	...
	\renewcommand{\cswinformsname}{C$\sharp$ Windows Forms und WPF}
	\renewcommand{\sqldevname}{SQL für Entwickler}
	\renewcommand{\htmlname}{HTML und CSS -- Grundlagen}
	...
	\renewcommand{\espanholname}{Spanisch}
	\renewcommand\francesname{Französisch}
	\renewcommand{\linguamaename}{Muttersprache}
	\renewcommand{\fluentename}{Fliessend}
	\renewcommand{\intermediarioname}{Mittelstufe}
	\renewcommand\basiconame{Grundlagen}
	% Outras habilidades
	\renewcommand{\outrosname}{Andere Kompetenzen}
	\renewcommand{\sistemassccname}{SCC Systeme}
	\renewcommand{\outraslinguagensname}{Modellierung}
